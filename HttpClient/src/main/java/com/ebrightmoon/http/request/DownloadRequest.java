...
public class DownloadRequest extends BaseHttpRequest<DownloadRequest> {
    ...
    private String dirName = AppConfig.DEFAULT_DOWNLOAD_DIR;
    private String fileName = AppConfig.DEFAULT_DOWNLOAD_FILE_NAME;

    public DownloadRequest(String suffixUrl) {
        super(suffixUrl);
        rootName = getDiskCachePath(HttpClient.getContext());
    }
